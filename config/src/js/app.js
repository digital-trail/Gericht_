...
// !кастомные селекты
// ? позволяет селектам кастомизироваться(на месте стандартного селекта образуется целая конструкция из разных <div>-ов которые мы сможем стилизировать как нам нужно)
...
// ! наблюдатель срабатявает когда обьект появляется на экране
flsScroll.scrollWatcher(false);

// ? позволит при клике на скролл передвинуца к следующему блоку
// Плавная навигация по странице
flsScroll.pageNavigation();

// ? делает чтоб при скроле к нему добавлялись классы
// Функционал добавления классов к хедеру при прокрутке
flsScroll.headerScroll();
// ! подключает функцию для паралакса
